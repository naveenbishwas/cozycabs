    ...
    <div className="stat">
      ...
      <section className="smooth-ride section-container">
        ...
        <div className="ride-content">
          ...
          <p>
            ...
            comes in. We don’t just provide cars—we provide comfort, flexibility,
            and peace of mind.
          </p>
          <p>
      ...
      <section className="quote-section section-container" id="quote-section">
        <div className="quote-info">
          ...
          <p>
            Tell us about your travel requirements and we'll provide a tailored
            rental solution with competitive pricing.
          </p>
          <ul className="benefits-list">
            <li>Free consultation and travel planning</li>
