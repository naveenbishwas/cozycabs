...
const InPatna = () => {
  ...
  const items = [
    {
      ...
      desc: "Our chauffeurs are trained, background-checked, and know Patna’s roads well. For safe and timely travel, trust our Patna car rental service.",
      icon: (
    ...
    },
    {
      ...
      desc: "From budget sedans and SUVs to premium vehicles, self drive cars in Patna, and even limo hire for special events—we have something for everyone.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "All fares are upfront with no hidden costs. From car rent in Patna for a few hours to long-term rentals, you know exactly what you’ll pay.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "Whether it’s early-morning airport transfers or late-night pickups, our rental cars in Patna are available anytime.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  const spots = [
    ...
    },
    {
      ...
      img: "./Sanjay-Gandhi-Biological.jpeg",
    ...
    <div>
      ...
      <section className="faq">
        <div className="faq-header">
          ...
          <p>
            Answers to common questions about our car rental services in Patna.
          </p>
        </div>
