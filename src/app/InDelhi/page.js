  ...
  const items = [
    {
      ...
      desc: "Our drivers know Delhi’s roads inside out—whether it’s the bustling lanes of Chandni Chowk, the wide stretches of Rajpath, or quick routes to Gurugram and Noida. Every chauffeur is background-checked, trained, and committed to making your ride smooth and safe.",
      icon: (
        // Shield check
    ...
    },
    {
      ...
      desc: "Need a small car for short trips, a premium sedan for corporate meetings, or a 7-seater SUV for family outings? From budget options to luxury car hire in Delhi, our fleet has the right vehicle for every occasion.",
      icon: (
        // Sedan
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "You’ll always know what you’re paying for. We provide estimates up front—per km rates, driver charges, parking, and tolls. Whether it’s a one-day rental in Delhi or an outstation trip, there are no surprises.",
      icon: (
        // Tag
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "Delhi never stops, and neither do we. Be it an early-morning airport drop, a late-night pickup from Connaught Place, or a last-minute car booking for outstation travel—our service runs round the clock.",
      icon: (
        // Clock + tick
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "Every vehicle is sanitized, GPS-enabled, and insured. Ideal for families, business travelers, and tourists who depend on a reliable Delhi car service.",
      icon: (
        // Headset
        <svg viewBox="0 0 24 24" aria-hidden="true">
  ...
  const faqs = [
    {
      ...
      a: "Economy rides start from around ₹12–₹15/km, premium cars from ₹25/km, and luxury from ₹35/km. You’ll always get a transparent fare estimate before booking.",
    },
    {
      q: "Can I book a cab from Delhi to other cities?",
      a: "Yes. Popular routes include Delhi–Agra, Jaipur, Rishikesh, Shimla, and Manali. One-way and round-trip options are available.",
    },
    {
      q: "Do you provide 24×7 airport transfers in Delhi?",
      a: "Absolutely. We cover all terminals at Indira Gandhi International Airport with timely pickups and drops, day or night.",
    },
    {
      q: "Is there a package for Delhi sightseeing?",
      a: "Yes. We provide half-day and full-day packages, such as 8 hrs / 80 km, to cover top attractions comfortably.",
    },
  ];
      ...
      <section className="heroeco" aria-label="Car Rental Hero Section">
        <div className="heroeco__copy">
          ...
          <h1 className="heroeco__title">
            CozyCabz Car Rental in Delhi – Safe, Reliable & Comfortable Rides
          </h1>
          <p className="heroeco__sub">
            Delhi blends history with modern life—but getting around can be
            overwhelming. With CozyCabz car rental in Delhi with driver, enjoy
            safe rides, verified chauffeurs, transparent pricing, and 24×7
            availability.
          </p>
        </div>
      </section>
      ...
      <section className="trustcc">
        <div className="trustcc__container">
          <h2 className="trustcc__title">
            Why Choose CozyCabs in<span> Delhi?</span>
          </h2>
      ...
      <section className="howrent" aria-labelledby="howrent-title">
        <div className="howrent__container">
          ...
          <p className="howrent__intro">
            Booking your ride with CozyCabz in Delhi takes just a few steps
          </p>
          ...
          <ul className="howrent__list">
            ...
            <li className="howrent__item">
              ...
              <p>
                Sit back, relax, and let our driver handle Delhi’s traffic
        ...
        <div className="attractions__container">
          <header className="attractions__head">
            <h2 id="attractions-title">
              Must-Visit Places in Delhi with CozyCabs
            </h2>
            <p>
              Delhi is a city where every street has a story—heritage forts,
              spiritual centers, vibrant markets, and modern hubs. With CozyCabz
              car rental in Delhi with driver, explore comfortably without
              worrying about traffic, parking, or last-minute cabs.
            </p>
          </header>
