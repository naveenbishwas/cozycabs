        ...
        <div className="quote-form">
          ...
          <form>
            <div className="form-grid">
              <input type="text" placeholder="Bride / Groom Name" required />
              ...
              <select required>
                ...
                <option>Stylish SUV</option>
                <option>Vintage Classic</option>
              </select>
              <input type="text" placeholder="Wedding Venue / City" />
              <textarea
                placeholder="Tell us about your wedding date, car decoration needs, and special requirements..."
                rows="4"
              />
            </div>
