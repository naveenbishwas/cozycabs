...
const Innovainpune = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Pune Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Pune. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Pune?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Pune, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Pune?",
      a: "Yes. We provide Innova car rentals for outstation travel from Pune to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Pune?",
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Pune" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Pune" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Pune</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            Pune, one of India’s major cities, offers a unique mix of culture,
            business, and lifestyle. Whether you’re traveling for work,
            sightseeing, or leisure, Cozy Cabz Innova car rental in Pune ensures
            a safe, comfortable, and convenient journey.
          </p>
        </div>
        <p>
          The Toyota Innova on rent in Pune is known for its spacious interiors
          and smooth ride. Whether you’re a tourist exploring or on an
        ...
        <p>
          In Pune’s busy roads, booking an Innova with driver in Pune gives you
          complete peace of mind. Cozy Cabz provides professional chauffeurs and
