...
const Innovainhyderabad = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Hyderabad Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Hyderabad. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Hyderabad?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Hyderabad, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Hyderabad?",
      a: "Yes. We provide Innova car rentals for outstation travel from Hyderabad to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Hyderabad?",
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Hyderabad" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Hyderabad" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Hyderabad</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            Hyderabad, one of India’s major cities, offers a unique mix of culture,
            business, and lifestyle. Whether you’re traveling for work,
            sightseeing, or leisure, Cozy Cabz Innova car rental in Hyderabad
            ensures a safe, comfortable, and convenient journey.
          </p>
        </div>
        <p>
          The Toyota Innova on rent in Hyderabad is known for its spacious
        ...
        <p>
          In Hyderabad’s busy roads, booking an Innova with driver in Hyderabad
...
export default Innovainhyderabad;
