      ...
      <section className="innova-content-section">
        ...
        <div className="innova-highlight-box">
          <p>
            ...
            sightseeing, or leisure, Cozy Cabz Innova car rental in Nagpur ensures
            a safe, comfortable, and convenient journey.
          </p>
        </div>
        <p>
          The Toyota Innova on rent in Nagpur is known for its spacious interiors
          and smooth ride. Whether you’re a tourist exploring or on an outstation
          trip, it’s ideal for families, corporate groups, or friends. With
          seating for up to 7 passengers, every journey becomes easy and
          enjoyable.
        </p>
        <p>
