...
const Innovainindore = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Indore Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Indore. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Indore?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Indore, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Indore?",
      a: "Yes. We provide Innova car rentals for outstation travel from Indore to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Indore?",
  ...
  return (
    <div className="innova-page">
      <head>
        <title>
          Innova Car Rental in Indore | Innova Crysta & Hycross with Driver –
          CozyCabz
        </title>
        <meta
          name="description"
          content="Book Innova car rental in Indore with CozyCabz. Choose Innova Crysta or Hycross for airport transfers, city rides & outstation trips. Clean cars, expert chauffeurs & transparent pricing."
        />
      </head>
      ...
      {/* Hero Section */}
      <InnovaBanner city="Indore" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Indore" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Indore</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            ...
            sightseeing, or leisure, CozyCabz Innova car rental in Indore
