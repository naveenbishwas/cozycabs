...
const Innovainguwahati = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Guwahati Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Guwahati. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Guwahati?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Guwahati, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Guwahati?",
      a: "Yes. We provide Innova car rentals for outstation travel from Guwahati to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Guwahati?",
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Guwahati" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Guwahati" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Guwahati</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            Guwahati, one of India’s major cities, offers a unique mix of culture,
        ...
        <p>
          The Toyota Innova on rent in Guwahati is known for its spacious
...
export default Innovainguwahati;
