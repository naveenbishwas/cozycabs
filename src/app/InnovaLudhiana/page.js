...
const Innovainludhiana = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Ludhiana Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Ludhiana. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Ludhiana?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Ludhiana, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Ludhiana?",
      a: "Yes. We provide Innova car rentals for outstation travel from Ludhiana to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Ludhiana?",
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Ludhiana" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Ludhiana" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Ludhiana</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            Ludhiana, one of India’s major cities, offers a unique mix of culture,
            business, and lifestyle. Whether you’re traveling for work,
            sightseeing, or leisure, Cozy Cabz Innova car rental in Ludhiana ensures
            a safe, comfortable, and convenient journey.
          </p>
        </div>
        <p>
          The Toyota Innova on rent in Ludhiana is known for its spacious interiors
        ...
        <p>
          In Ludhiana’s busy roads, booking an Innova with driver in Ludhiana gives
          you complete peace of mind. Cozy Cabz provides professional chauffeurs and
          flexible rental packages – from airport transfers to day trips and
...
export default Innovainludhiana;
