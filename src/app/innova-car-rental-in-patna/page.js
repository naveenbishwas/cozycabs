...
const Innovainpatna = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Patna Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Patna. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Patna?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Patna, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Patna?",
      a: "Yes. We provide Innova car rentals for outstation travel from Patna to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Patna?",
  ...
  return (
    <div className="innova-page">
      <head>
        <title>
          Innova Car Rental in Patna | Innova Crysta & Hycross with Driver –
          CozyCabz
        </title>
        <meta
          name="description"
          content="Book Innova car rental in Patna with CozyCabz. Choose from Innova Crysta or Hycross for airport transfers, local rides, and outstation trips. Clean cars, expert chauffeurs & transparent fares."
        />
      </head>
      ...
      {/* Hero Section */}
      <InnovaBanner city="Patna" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Patna" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Patna</span>
        </h2>
        <p>
        ...
        <p>
          The Toyota Innova on rent in Patna is known for its spacious interiors
