  ...
  const items = [
    {
      ...
      desc: "Our chauffeurs are well versed with Kanpur’s traffic, lanes, and best routes, making your journeys safe and timely.",
      icon: (
    ...
    },
    {
      ...
      desc: "From hatchbacks and sedans to SUVs and luxury cars, we also offer self drive cars in Kanpur and multi-seater options.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "All quotes include fuel, tolls, parking, and driver charges. No hidden costs—ever.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "Early morning airport transfers or late-night city rides—our Kanpur car rental service is at your disposal.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "Each vehicle is thoroughly sanitized, GPS-monitored, and insured, ensuring peace of mind for every trip.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div>
      ...
      <section className="faq">
        <div className="faq-header">
          ...
          <p>
            Answers to common questions about our car rental services in Kanpur.
          </p>
        </div>
