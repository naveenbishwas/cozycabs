...
const InNagpur = () => {
  ...
  const items = [
    ...
    },
    {
      ...
      desc: "We offer hatchbacks, sedans, SUVs, tempo travelers, and luxury cars. Customers can also choose self drive car in Nagpur options for privacy or 7 seater rental cars near me for family trips.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "From early-morning airport transfers to late-night drops, our rental cars in Nagpur are available anytime.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div>
      ...
      <section className="faq">
        <div className="faq-header">
          ...
          <p>
            Answers to the most common questions about our car rental services
            in Nagpur.
          </p>
        </div>
