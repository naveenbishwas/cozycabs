...
const Innovainbhopal = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Bhopal Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Bhopal. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Bhopal?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Bhopal, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Bhopal?",
      a: "Yes. We provide Innova car rentals for outstation travel from Bhopal to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Bhopal?",
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Bhopal" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Bhopal" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Bhopal</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            ...
            sightseeing, or leisure, Cozy Cabz Innova car rental in Bhopal ensures
            a safe, comfortable, and convenient journey.
          </p>
        </div>
        <p>
          The Toyota Innova on rent in Bhopal is known for its spacious interiors
