...
const Innovainrajkot = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Rajkot Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Rajkot. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Rajkot?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Rajkot, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Rajkot?",
      a: "Yes. We provide Innova car rentals for outstation travel from Rajkot to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Rajkot?",
  ...
  return (
    <div className="innova-page">
      <head>
        <title>
          Innova Car Rental in Rajkot | CozyCabz – Crysta & Hycross with Driver
        </title>
        <meta
          name="description"
          content="Hire Toyota Innova Crysta or Hycross in Rajkot for airport transfers, business trips, and outstation rides. Enjoy 24×7 chauffeur service, clean vehicles, and transparent pricing from CozyCabz."
        />
        <meta
          property="og:title"
          content="Innova Car Rental in Rajkot | CozyCabz – Reliable Chauffeur Service"
        />
        <meta
          property="og:description"
          content="Book Innova in Rajkot for airport pickups, sightseeing, or family trips. CozyCabz offers premium comfort, safety, and convenience for every journey."
        />
      ...
      {/* Hero Section */}
      <InnovaBanner city="Rajkot" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Rajkot" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Rajkot</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            Rajkot, one of India’s major cities, offers a unique mix of culture,
            business, and lifestyle. Whether you’re traveling for work,
            sightseeing, or leisure, CozyCabz Innova car rental in Rajkot
            ensures a safe, comfortable, and convenient journey.
          </p>
        </div>
        <p>
          The Toyota Innova on rent in Rajkot is known for its spacious
        ...
        <p>
          In Rajkot’s busy roads, booking an Innova with driver in Rajkot gives
