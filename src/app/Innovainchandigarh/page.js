...
const Innovainchandigarh = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Chandigarh Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Chandigarh. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Chandigarh?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Chandigarh, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Chandigarh?",
      a: "Yes. We provide Innova car rentals for outstation travel from Chandigarh to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Chandigarh?",
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Chandigarh" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Chandigarh" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Chandigarh</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            Chandigarh, one of India’s major cities, offers a unique mix of culture,
        ...
        <p>
          The Toyota Innova on rent in Chandigarh is known for its spacious
        ...
        <p>
          In Chandigarh’s busy roads, booking an Innova with driver in Chandigarh
...
export default Innovainchandigarh;
