...
const Innovainjaipur = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Jaipur Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Jaipur. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Jaipur?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Jaipur, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Jaipur?",
      a: "Yes. We provide Innova car rentals for outstation travel from Jaipur to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Jaipur?",
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Jaipur" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Jaipur" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Jaipur</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            ...
            sightseeing, or leisure, Cozy Cabz Innova car rental in Jaipur ensures
            a safe, comfortable, and convenient journey.
          </p>
        </div>
        <p>
          The Toyota Innova on rent in Jaipur is known for its spacious interiors
        ...
        <p>
          In Jaipur’s busy roads, booking an Innova with driver in Jaipur gives you
