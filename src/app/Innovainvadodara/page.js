...
const Innovainvadodara = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Vadodara Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Vadodara. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Vadodara?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Vadodara, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Vadodara?",
      a: "Yes. We provide Innova car rentals for outstation travel from Vadodara to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Vadodara?",
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Vadodara" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Vadodara" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Vadodara</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            Vadodara, one of India’s major cities, offers a unique mix of culture,
            business, and lifestyle. Whether you’re traveling for work,
            sightseeing, or leisure, Cozy Cabz Innova car rental in Vadodara
            ensures a safe, comfortable, and convenient journey.
          </p>
        </div>
        <p>
          The Toyota Innova on rent in Vadodara is known for its spacious interiors
        ...
        <p>
          In Vadodara’s busy roads, booking an Innova with driver in Vadodara gives
...
export default Innovainvadodara;
