...
const Innovainchennai = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Chennai Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Chennai. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Chennai?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Chennai, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Chennai?",
      a: "Yes. We provide Innova car rentals for outstation travel from Chennai to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Chennai?",
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Chennai" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Chennai" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Chennai</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            Chennai, one of India’s major cities, offers a unique mix of culture,
            business, and lifestyle. Whether you’re traveling for work,
            sightseeing, or leisure, Cozy Cabz Innova car rental in Chennai
            ensures a safe, comfortable, and convenient journey.
          </p>
        </div>
        <p>
          The Toyota Innova on rent in Chennai is known for its spacious interiors
        ...
        <p>
          In Chennai’s busy roads, booking an Innova with driver in Chennai gives
...
export default Innovainchennai;
