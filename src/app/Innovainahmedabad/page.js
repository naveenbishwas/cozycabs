...
const Innovainahmedabad = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Ahmedabad Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Ahmedabad. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Ahmedabad?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Ahmedabad, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Ahmedabad?",
      a: "Yes. We provide Innova car rentals for outstation travel from Ahmedabad to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Ahmedabad?",
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Ahmedabad" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Ahmedabad" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Ahmedabad</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            Ahmedabad, one of India’s major cities, offers a unique mix of culture,
        ...
        <p>
          The Toyota Innova on rent in Ahmedabad is known for its spacious
...
export default Innovainahmedabad;
