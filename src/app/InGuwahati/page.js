  ...
  const items = [
    {
      ...
      desc: "Every chauffeur is trained, background-checked, and experienced with city and outstation routes.",
      icon: (
    ...
    },
    {
      ...
      desc: "Economy hatchbacks, premium sedans, SUVs, tempo travelers, and rental cars in Guwahati for all occasions.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "No hidden costs. You get clear car rental price in Guwahati before booking.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "Choose hourly, daily, or outstation packages with options for car hire or self-drive rentals.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    },
    {
      ...
      desc: "Early morning pickup or late-night drop—our Guwahati car rental service is always available.",
      icon: (
        <svg viewBox="0 0 24 24" aria-hidden="true">
    ...
    <div>
      ...
      <section className="faq">
        <div className="faq-header">
          ...
          <p>
            Answers to the most common questions about our Guwahati car rentals.
          </p>
        </div>
