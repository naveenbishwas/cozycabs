...
const Innovainvisakhapatnam = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Visakhapatnam Airport pickup or drop?",
      a: "Yes, we offer Innova Crysta rentals for Vizag Airport transfers with professional drivers ensuring comfort.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Visakhapatnam?",
      a: "Yes, our Innovas are available for sightseeing trips covering beaches, Kailasagiri, and Araku Valley.",
    },
    {
      q: "Is Innova available for outstation trips from Visakhapatnam?",
      a: "Yes, you can book for long trips to Hyderabad, Vijayawada, or Rajahmundry.",
    },
    {
      q: "Are your Innovas clean and well-maintained?",
      a: "All vehicles are sanitized and serviced to ensure passenger comfort.",
    },
    {
      q: "How can I book an Innova cab in Visakhapatnam?",
      a: "Visit our website or call 7387382383 for quick reservations.",
    },
  ];
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Visakhapatnam" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Visakhapatnam" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Visakhapatnam</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            ...
            tours. Visit popular sites like RK Beach, Kailasagiri, or Araku Valley
...
export default Innovainvisakhapatnam;
