...
const InAhmedabad = () => {
  ...
  const services = [
    { title: "Local Rentals", text: "Hourly or full-day packages for shopping, meetings, or sightseeing." },
    { title: "Airport Transfers", text: "Reliable rides to and from Sardar Vallabhbhai Patel International Airport." },
    { title: "Outstation Trips", text: "Round-trip and one-way travel to Vadodara, Udaipur, Dwarka, Somnath and more." },
    { title: "Luxury Cars", text: "Premium sedans and SUVs for weddings, VIP events, and corporate travel." },
    { title: "Self-Drive Options", text: "Affordable self-drive rentals for privacy and flexibility." },
    { title: "Corporate & Long-Term Leasing", text: "Tailored monthly plans with competitive rates for businesses and regular travelers." },
  ];

  const spots = [
    { title: "Sabarmati Ashram", img: "/g1.webp", alt: "Sabarmati Ashram campus", paragraphs: ["Peaceful retreat showcasing India’s freedom struggle—Gandhi’s belongings, letters, and photographs along the river."] },
    { title: "Kankaria Lake", img: "/g2.webp", alt: "Kankaria Lakefront", paragraphs: ["Family favorite with boat rides, zoo, toy train, balloon rides, and landscaped gardens—vibrant in the evenings."] },
    { title: "Sidi Saiyyed Mosque", img: "/g3.webp", alt: "Sidi Saiyyed Jali", paragraphs: ["Famous for its intricate stone latticework windows—the iconic ‘Tree of Life’—a masterpiece of Indo-Islamic art."] },
    { title: "Adalaj Stepwell", img: "/g4.webp", alt: "Adalaj Stepwell carvings", paragraphs: ["Stunning five-story stepwell with Indo-Islamic architecture and ornate carvings—15th-century heritage."] },
    { title: "Sabarmati Riverfront", img: "/g1.webp", alt: "Sabarmati Riverfront walkway", paragraphs: ["Modern landmark with gardens, cycling tracks, and boating—ideal for walks, leisure, and photography."] },
    { title: "Jama Masjid", img: "/g2.webp", alt: "Ahmedabad Jama Masjid", paragraphs: ["Elegant 15th-century mosque built with yellow sandstone—grand domes, carvings, and a vast courtyard."] },
  ];

  const faqs = [
    { q: "How much does car rental in Ahmedabad cost per km?", a: "Economy cars start at ₹12/km, premium sedans at ₹25/km, and luxury cars at ₹35/km. Transparent rates with Cozy Cabz." },
    { q: "Can I book a car rental in Ahmedabad with driver for outstation trips?", a: "Yes—one-way and round-trip packages to nearby destinations are available." },
    { q: "Do you provide airport transfers in Ahmedabad?", a: "Absolutely. On-time transfers to and from Sardar Vallabhbhai Patel International Airport." },
    { q: "Are self-drive cars available in Ahmedabad?", a: "Yes—self-drive options are available for independence and flexibility." },
    { q: "How do I book quickly?", a: "Book online in a few steps—confirmation and driver details are shared instantly." },
  ];
    ...
    <div>
      ...
      <section className="heroeco" aria-label="Car Rental Hero Section">
        <div className="heroeco__copy">
          ...
          <p className="heroeco__sub">
            Ahmedabad blends heritage with modern living—from Sabarmati Ashram and stepwells to buzzing markets and IT zones. Cozy Cabz provides trusted car rental with driver so every journey is safe and convenient.
          </p>
        </div>
      </section>
      ...
      <section className="trustcc">
        <div className="trustcc__container">
          <h2 className="trustcc__title">Why Choose Cozy Cabz in<span> Ahmedabad?</span></h2>
      ...
      <section className="howrent" aria-labelledby="howrent-title">
        <div className="howrent__container">
          ...
          <p className="howrent__intro">Our car rental services in Ahmedabad are designed to suit every travel need:</p>
      ...
      <section className="attractions" aria-labelledby="attractions-title">
        <div className="attractions__container">
          <header className="attractions__head">
            <h2 id="attractions-title">Must-Visit Places in Ahmedabad with Cozy Cabz</h2>
            <p>Explore top attractions comfortably with Cozy Cabz—travel at your pace without traffic or parking worries.</p>
          </header>
      ...
      <section className="faq">
        <div className="faq-header">
          ...
          <p>Answers to the most common questions about our Ahmedabad services.</p>
        </div>
...
const InAhmedabad = () => {
  ...
  const spots = [
    { title: "Victoria Memorial", img: "/g1.webp", alt: "Victoria Memorial", paragraphs: ["Iconic marble monument with lush gardens and a rich museum showcasing Kolkata’s colonial-era heritage."] },
    { title: "Howrah Bridge", img: "/g2.webp", alt: "Howrah Bridge", paragraphs: ["Engineering marvel over the Hooghly River—driving across captures the pulse of the city."] },
    { title: "Dakshineswar Kali Temple", img: "/g3.webp", alt: "Dakshineswar Temple", paragraphs: ["Renowned riverside temple dedicated to Goddess Kali with 12 Shiva shrines and stunning architecture."] },
    { title: "Indian Museum", img: "/g4.webp", alt: "Indian Museum", paragraphs: ["India’s oldest and largest museum with rare antiques, fossils, paintings, textiles, and an Egyptian mummy."] },
    { title: "Science City", img: "/g1.webp", alt: "Science City", paragraphs: ["Interactive exhibits, 3D shows, and space theater—education meets entertainment for all ages."] },
    { title: "Marble Palace", img: "/g2.webp", alt: "Marble Palace", paragraphs: ["19th-century mansion with neoclassical architecture, European art, and an ornate private collection."] },
  ];

  const faqs = [
    { q: "What are the charges for car rental in Kolkata?", a: "Economy cars start at ₹12/km, premium sedans at ₹25/km, and luxury cars from ₹35/km. Transparent rates with no hidden fees." },
    { q: "Can I rent a car in Kolkata with driver for outstation trips?", a: "Yes, one-way and round-trip outstation packages are available." },
    { q: "Do you offer airport transfers in Kolkata?", a: "Absolutely—24×7 airport pickups and drops are available." },
    { q: "Are self-drive cars available?", a: "Yes, self-drive options are available for flexibility and privacy." },
    { q: "How do I book quickly?", a: "Book online in a few steps—confirmation and driver details are shared instantly." },
  ];
    ...
    <div>
      ...
      <section className="heroeco" aria-label="Car Rental Hero Section">
        <div className="heroeco__copy">
          ...
          <p className="heroeco__sub">
            Kolkata, the City of Joy, blends colonial architecture, vibrant culture, and modern lifestyle. Cozy Cabz provides dependable car rental with driver for safe, smooth, and stress-free travel—local trips, business, outstation, or airport.
          </p>
        </div>
      </section>
      ...
      <section className="trustcc">
        <div className="trustcc__container">
          <h2 className="trustcc__title">Why Choose Cozy Cabz in<span> Kolkata?</span></h2>
          <div className="trustcc__grid">
            {items.map((it, i) => (
              <article className="trustcc__card" key={i}>
                <div className="trustcc__icon">{it.icon}</div>
      ...
      <section className="howrent" aria-labelledby="howrent-title">
        <div className="howrent__container">
          ...
          <p className="howrent__intro">Tailored car rental services to suit every requirement:</p>
          <ul className="howrent__list">
            {services.map((s) => (
              <li className="howrent__item" key={s.title}>
                <h3>{s.title}</h3>
      ...
      <section className="attractions" aria-labelledby="attractions-title">
        <div className="attractions__container">
          <header className="attractions__head">
            <h2 id="attractions-title">Must-Visit Places in Kolkata with Cozy Cabz</h2>
            <p>Explore Kolkata’s famous landmarks comfortably with Cozy Cabz—no traffic or parking worries.</p>
          </header>
          <div className="attractions__grid">
            {spots.map((s) => (
              <article className="spot" key={s.title}>
