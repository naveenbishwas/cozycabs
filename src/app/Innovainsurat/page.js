...
const Innovainsurat = () => {
  ...
  const faqs = [
    {
      q: "Can I book an Innova for Surat Airport pickup or drop?",
      a: "Yes, we provide Innova Crysta and Hycross rentals for the airport in Surat. Our drivers ensure timely airport pickups and drops with complete comfort and reliability.",
    },
    {
      q: "Do you offer Innova rental for sightseeing in Surat?",
      a: "Absolutely! You can hire an Innova for local sightseeing across Surat, covering popular landmarks and attractions in and around the city.",
    },
    {
      q: "Is Innova available for outstation trips from Surat?",
      a: "Yes. We provide Innova car rentals for outstation travel from Surat to nearby destinations with one-way or round-trip travel options.",
    },
    {
    ...
    {
      q: "How can I book an Innova cab in Surat?",
  ...
  return (
    <div className="innova-page">
      ...
      {/* Hero Section */}
      <InnovaBanner city="Surat" />

      {/* Number Counters */}
      <NumberCounter />

      {/* Gallery Section */}
      <InnovaGallerySection city="Surat" />
      ...
      <section className="innova-content-section">
        <h2 className="innova-description-heading">
          Innova Car Rental in <span>Surat</span>
        </h2>
        <p>
        ...
        <div className="innova-highlight-box">
          <p>
            ...
            sightseeing, or leisure, Cozy Cabz Innova car rental in Surat ensures
            a safe, comfortable, and convenient journey.
          </p>
        </div>
        <p>
          The Toyota Innova on rent in Surat is known for its spacious interiors
        ...
        <p>
          In Surat’s busy roads, booking an Innova with driver in Surat gives you
